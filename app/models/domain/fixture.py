...
class Goal(BaseModel):
    home_team: Optional[int] = Field(title="HomeTeamGoals", description="Goals scored by home team")
    away_team: Optional[int] = Field(title="AwayTeamGoals", description="Goals scored by away team")
...
class Fixture(BaseModel):
    ...
    first_half_start: Optional[int] = Field(..., title="FirstHalfStartTime")
    second_half_start: Optional[int] = Field(..., title="SecondHalfStartTime")
    round: str = Field(..., title="Round")
    status: str = Field(..., title="Status")
    elapsed: Optional[int] = Field(..., title="Elapsed")
    stadium: str = Field(..., title="Stadium")
    city: str = Field(..., title="City")
    referee: Optional[str] = Field(..., title="Referee")
